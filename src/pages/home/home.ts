...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, private modalCtrl: ModalController, private alertCtrl: AlertController, public db: AngularFireDatabase, public popoverCtrl: PopoverController) {
